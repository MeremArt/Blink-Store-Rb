...
export default function TableComp(prop:TableCompProps) {
  ...
  return (
    <div className='flex p-4 gap-[16px] items-start self-stretch border-b border-[#DFDFDF]'>
            <div>
            <Typography customClassName='text-gray-600 font-inter text-lg font-normal leading-normal'>{text1}</Typography>
            </div>
            <div>
            <Typography customClassName='text-black font-inter text-lg font-normal leading-normal'>{text2}</Typography>
            </div>
            ...
            <div className='flex items-center gap-2'>
                <div className='flex flex-col items-end gap-2'>
                    ...
                    <Typography customClassName='text-[#5B5B5B] font-inter text-[16px] font-normal leading-normal'>{text6}</Typography>
                </div>
                <div>
                    <DollarIcon/>
                </div>
