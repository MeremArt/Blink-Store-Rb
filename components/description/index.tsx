  ...
  return (
    <div className='flex flex-col items-start gap-3 self-stretch'>
        ...
        <div className='flex h-[104px] px-6 py-4 items-start gap-1 self-stretch rounded-sm border border-[#BFBFBF] bg-[#FAFAFA]'>
            <textarea id='description' placeholder='Enter product description' value={value} className='w-full h-full border-none outline-none bg-transparent resize-none mmd:placeholder:text-[0.875rem]' onChange={onChange}/>
        </div>
    </div>
  )
}
