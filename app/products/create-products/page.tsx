...
const router =useRouter();
  ...
  return (
       ...
       <div className='mx-auto w-[826px] h-[48px] relative'>
         ...
         <div className=' mx-auto flex flex-col items-start max-w-[826px] w-full px-[136px] py-8 gap-8 bg-[#FFF] shadow-[0_0_32px_0_rgba(0,_0,_0,_0.08)]'>
        <div className='w-full'>
            ...
            <form className='flex flex-col items-start gap-10 self-stretch' onSubmit={handleFormSubmit}>
                ...
                <div className='w-full'>
                <Input id='ProductName' value={name} name="ProductName" label='Product Name' placeholder="Fake Nikes" passwordWay={false} onChange={handleInputChange}/>
                </div>
                <div className='w-full'>
                <Input id='Amount' value={amount} name="Amount" label='Amount' placeholder="35,479.97" passwordWay={false} icon2={<NairaLogo/>} onChange={handleInputChange}/>
                </div>
                <div className='w-full'>
