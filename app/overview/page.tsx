...
import { updateTransaction, updateTransactionState } from "@/store/redux-slices/transaction-slice";
...
function Page() {
    ...
    useEffect(()=>{
        const getUserTransactions = async()=>{
            ...
            const response = await axios.get(`https://ribh-store.vercel.app/api/v1/transaction?publicKey=${getUserId}&numTx=2`);
    ...
    console.log(transactionData, 'this is the data')
  return (
    <>
      <div className="flex md:max-w-[406px] lg:w-[406px] flex-col items-start gap-4 h-full mxs:w-full">
        ...
        <div className="flex items-start gap-2 self-stretch mxs:flex-col mxs:w-full">
         ...
         {/* /*-----fourth div-----/ */}
         <div className="relative w-full h-[360px] p-8 flex flex-col justify-between items-center bg-cover bg-center rounded-[8px]" style={{ backgroundImage: `url(${container})` }}>
  {/* Shopping Image */}
